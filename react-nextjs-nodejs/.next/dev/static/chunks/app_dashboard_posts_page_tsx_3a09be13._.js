...
async function Posts() {
    ...
    const { data: posts, error, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(("TURBOPACK compile-time value", "http://localhost:9000") + '/api/posts');
    const DeletePost = ({ id })=>{
...
_s(Posts, "10KIAhXToU5oO+ZhghLObZ2gkt4=", false, function() {
    return [
